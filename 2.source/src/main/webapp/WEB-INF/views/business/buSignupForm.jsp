			...
			<div class="col-lg-8 col-xl-6">
				<div class="card rounded-3">
          		...
          		<div class="card-body p-4 p-md-5">
            		<h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">사업자 회원가입</h3>
						...
						<div class="form-floating mt-3">
									...
									<label><span>대표자명</span></label>
								</div>
								
								<div class="form-floating mt-3">
									<input type="text" name="mm_name" class="form-control form-control-lg"  required>
									<label><span>사업자 등록번호</span></label>
								</div>
							...
							<br>
							<div align="center"> 
								<a class="btn btn-primary" href="${pageContext.request.contextPath}/common/loginForm">가입승인요청</a>
